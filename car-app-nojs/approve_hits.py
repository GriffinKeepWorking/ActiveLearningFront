...
aws_access_key_id = "AKIAJD23YK55DWATJICA"
aws_secret_access_key = "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"
client = boto3.client(
...
#         HITTypeId="3LC6UUY7PRUHBO293270YWERO4NDDG",
#         Status = 'Reviewable',
#         MaxResults=10,
#     )
...
for assignment in assignments:
    ...
    print ("Assignment {0} completed by user {1}".format(worker_id, only_answer))
